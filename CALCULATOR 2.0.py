...
def equal():
    ...
    try:
        ...
        equation_label.set("YOU F**KED UP")
        equation_text = ""
...
label = Label(window, textvariable=equation_label, font=('consolas', 20), bg="light blue", width=24, height=3)
label.pack()
...
equal_button = Button(frame, text='=', height=4, width=9, font=35, command=equal)
